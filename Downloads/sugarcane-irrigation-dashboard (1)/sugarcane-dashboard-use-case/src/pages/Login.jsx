...
export default function Login({ onLogin }) {
  ...
  function validate() {
    ...
    if (!form.id.trim()) {
      ...
      next.id =
        "User ID must be at least 4 characters (letters, numbers, '.', '_').";
    }
  ...
  function handleSubmit(e) {
    ...
    // Stop if the fields themselves are invalid
    ...
    if (form.id !== DEMO_ID || form.password !== DEMO_PASSWORD) {
      setErrors({
        login: "Incorrect User ID or password. Please try again.",
      });
      return;
    }
        ...
        >
          ...
          <div className="form-group">
            ...
            <input
              ...
              className={
                submitted && errors.id ? "input-error" : ""
              }
            />
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={handleChange}
              className={
                submitted && (errors.password || errors.login)
                  ? "input-error"
                  : ""
              }
            />
